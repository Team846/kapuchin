...
actual fun Named.pref(fallback: Boolean) = Preference(this, fallback, f(Unit), f(fallback), { true }, ::registerCallback)
...
actual fun <Q : Quan<Q>> Named.pref(fallback: Number, withUnits: UomConverter<Q>) =
        Preference(this, withUnits(fallback.toDouble()), f(Unit), f(withUnits(fallback.toDouble())), { true }, ::registerCallback)
