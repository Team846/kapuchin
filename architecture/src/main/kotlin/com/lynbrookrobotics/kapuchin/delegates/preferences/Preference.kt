...
class Preference<Value>(private val fallback: Value, private val get: (String, Value) -> Value) : WithEventLoop, DelegateProvider<Named, Value> {
    ...
    override fun provideDelegate(thisRef: Named, prop: KProperty<*>): ReadOnlyProperty<Named, Value> {
        name = namePreference(thisRef, prop)
