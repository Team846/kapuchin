...
//
//suspend fun Subsystems.verifyOdometry() = startChoreo("Verify Odometry") {
//    choreography {
...
//}
//
//suspend fun Subsystems.wall() = startChoreo("wall") {
//    choreography {
////        drivetrain.followTrajectory(fastAsFuckLine(4.Foot), 15.Inch, 2.Inch, reverse = false)
//    }
//}
//
//suspend fun Subsystems.shootWall() = startChoreo("shoot wall") {
//    choreography {
...
//}
//
//suspend fun Subsystems.`I1 shoot C1 I2 shoot`() = startChoreo("I1 shoot C1 I2 shoot") {
//    choreography {
...
//
//        val collectJob = launch { if (finishedReindex) intakeBalls() }
...
//}
//
//suspend fun Subsystems.`I2 shoot C1 I2 shoot`() = startChoreo("I2 shoot C1 I2 shoot") {
//    choreography {
...
//
//            val snapshot1 =
//                bestShot(limelight.hardware.conversions.goalPositions(reading1, robotPosition.bearing, pitch))
//            if (snapshot1 == null) {
