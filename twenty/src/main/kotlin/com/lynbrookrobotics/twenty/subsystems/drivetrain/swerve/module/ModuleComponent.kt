...
class ModuleComponent(hardware: ModuleHardware
    ...
    override val fallbackController: DrivetrainComponent.(Time) -> OffloadedOutput = {
    ...
    override fun ModuleHardware.output(wheelValue: OffloadedOutput, angleValue: OffloadedOutput) {
        wheelValue.writeTo(wheelEsc, pidController)
        angleValue.writeTo(angleEsc)
